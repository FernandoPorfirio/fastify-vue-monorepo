 ...
 */
export function expectValidationError(response: any, field?: string, message?: string): void {
 ...
 */
export function expectSuccess(response: any, statusCode: number = 200): void {
  expect(response.statusCode).toBe(statusCode)
...
export function expectPaginatedResponse(
  ...
  const { statusCode = 200, minItems, maxItems, page, limit } = options
 ...
 */
export function expectProperty(response: any, path: string, value?: any): void {
  const body = typeof response.body === 'string' ? JSON.parse(response.body) : response.body
 ...
 */
export function expectCreated(response: any, locationPattern?: string | RegExp): void {
